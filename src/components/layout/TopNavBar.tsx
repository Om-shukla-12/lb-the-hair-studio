        ...
        <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto h-20">
          ...
          >
            <motion.div 
              ...
              className="relative h-[40px] md:h-[45px] lg:h-[55px] w-[40px] md:w-[45px] lg:w-[55px] flex-shrink-0 group-hover:scale-105 transition-transform duration-500"
            >
              <Image 
            ...
            <div className="flex flex-col justify-center">
              <motion.span 
                ...
                className="font-serif text-lg md:text-xl lg:text-2xl font-bold text-[#111111] tracking-tight leading-tight"
              >
                The Hair Studio
              </motion.span>
              <motion.span 
                ...
                className="text-[8px] md:text-[9px] tracking-widest text-[#5A5A5A] uppercase font-semibold"
              >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.name}
                  href={link.href}
                  className={`font-label-sm text-label-sm h-full flex items-center transition-all duration-300 ${
                    isActive
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/booking" className="btn-primary bg-[#8B0000] hover:bg-[#5C0000] text-white font-semibold text-sm uppercase px-8 py-3 rounded-full transition-all duration-300 tracking-widest shadow-[0_10px_30px_rgba(139,0,0,0.2)]">
              Book Now
            </Link>
          </div>
