  ...
  return (
    <>
      ...
      <main className="flex-grow pt-20" style={{ background: "var(--bg)", color: "var(--text)" }}>
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center pt-20 px-4 md:px-8 overflow-hidden" style={{ background: "var(--bg)" }}>
          ...
          <div className="max-w-4xl mx-auto text-center z-10">
            ...
            <motion.p
              ...
              className="text-lg text-[var(--text-muted)] max-w-2xl mx-auto font-light leading-relaxed"
            >
